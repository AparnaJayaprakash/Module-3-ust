...
//		ApplicationContext context = new ClassPathXmlApplicationContext("beans.xml");     //can be write like this also
		...
		Line line1 = (Line)context.getBean("line");                 //This way also possible
